...
def fine_tune_bert(epochs: int = 5, batch_size: int = 4, mode: str = 'token_type_IDs'):
    ...
    # Define filepaths
    TRAIN_DATA_PATH = "Unpermuted_Datasets/mini_train.json"  # or path to full train set
    DEV_DATA_PATH = "Unpermuted_Datasets/mini_dev.json"  # or path to full train/dev set
