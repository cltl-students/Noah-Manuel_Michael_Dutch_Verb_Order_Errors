...
def shuffle_only_verb_positions():
    ...
    :return: None
    """
    df = pd.read_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Unpermuted_Datasets/Dataset_Construction/Unpermuted_Datasets/'
    ...
    df_new.to_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Unpermuted_Datasets/Dataset_Construction/Unpermuted_Datasets/'
