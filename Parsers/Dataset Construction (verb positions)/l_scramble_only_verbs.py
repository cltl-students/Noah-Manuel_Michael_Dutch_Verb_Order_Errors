...
def shuffle_only_verb_positions():
    ...
    :return: None
    """
    df = pd.read_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Data/'
                     'readability_data_scrambled.tsv', sep='\t', header=0, encoding='utf-8')
    ...
    df_new.to_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Data/'
                  'readability_data_scrambled_plus_verbs.tsv', sep='\t', header=True, index=False, encoding='utf-8')
