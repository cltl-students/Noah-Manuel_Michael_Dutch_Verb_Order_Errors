...
def get_datasplit():
    ...
    :return:
    """
    df_edia = pd.read_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted '
                          'Datasets/readability_data.tsv', sep='\t', encoding='utf-8', header=0)
    df_lassy = pd.read_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted '
                           'Datasets/lassy_data.tsv', sep='\t', encoding='utf-8', header=0)
    df_wainot = pd.read_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted '
    ...
    df_test.to_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted Datasets/'
                   'test.tsv', sep='\t', index_label='index', encoding='utf-8')
    df_dev.to_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted Datasets/'
                  'dev.tsv', sep='\t', index_label='index', encoding='utf-8')
    df_train.to_csv('/mnt/c/Users/nwork/OneDrive/Studium/ma_thesis/Data/Dataset Construction/Unpermuted Datasets/'
