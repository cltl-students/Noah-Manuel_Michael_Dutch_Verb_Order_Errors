...
# Unpermuted_Datasets reader for KU Leuven Corpus
...
def preprocess_leerder_data():
    ...
    :return:
    """
    with open('Annotation/Unpermuted_Datasets/leerder_corpus_KU.html', encoding='utf-8') as infile:
        html = infile.read()
    ...
    df.to_csv('Annotation/Unpermuted_Datasets/leerder_corpus_KU_preprocessed.tsv', sep='\t', header=True, index=True,
