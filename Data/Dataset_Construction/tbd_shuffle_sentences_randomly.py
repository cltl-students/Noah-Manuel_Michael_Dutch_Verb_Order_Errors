...
def shuffle_sentences_randomly(path_to_file):
    ...
    df_sents.to_csv('Unpermuted_Datasets/readability_data_shufled.tsv', sep='\t', header=True, encoding='utf-8', index_label='index')
    print('Scrambled data saved to file.')


if __name__ == '__main__':
    path_to_test_file = 'Unpermuted_Datasets/test.tsv'
    shuffle_sentences_randomly(path_to_test_file)
    path_to_train_file = 'Unpermuted_Datasets/train.tsv'
    shuffle_sentences_randomly(path_to_train_file)
    path_to_dev_file = 'Unpermuted_Datasets/dev.tsv'
