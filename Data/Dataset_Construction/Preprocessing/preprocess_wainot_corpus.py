...
# This script was pair-programmed with ChatGPT (v4) (parsing with bs4)
...
def preprocess_wainot_corpus():
    ...
    file_list = glob.glob('../Unpermuted_Datasets/Originals/wainot_corpus/*.xml')
    ...
    df.to_csv('../Unpermuted_Datasets/wainot_data.tsv', sep='\t', encoding='utf-8', index_label='index')
